...
%*********** a
%***** Day One
%P.acuScale = -0.4;  P.sampling_mid = 10.5;   % 3 deg ecc .. change to 11
%P.acuScale = 0.4;   P.sampling_mid = 8.5; %7.5;   % 7 deg ecc ... change to 7.0
%mid next time
%*****Day Two
%P.acuScale = 0.6;   P.sampling_mid = 6.5;   % 8 deg ecc
%P.acuScale = -0.2;  P.sampling_mid = 9.5;   % 4 deg ecc
%**** Day Three
%P.acuScale = -0.6;  P.sampling_mid = 11.0; %12.0;  % 2 deg ecc
%P.acuScale = 0.2;   P.sampling_mid = 7.5;   % 6 deg ecc
%*** Day Four
%P.acuScale = 0.0;   P.sampling_mid = 9.0; %8.0;   % 5 deg ecc
%P.acuScale = 0.6;   P.sampling_mid = 6.5;   % 8 deg ecc
%*** Day Five
%P.acuScale = 0.2;   P.sampling_mid = 8; %7.5;   % 6 deg ecc
%P.acuScale = -0.4;  P.sampling_mid = 9.5; %10.5;   % 3 deg ecc .. change to 11
%*** Day Six
%P.acuScale = 0.4;   P.sampling_mid = 7.0;   % 7 deg ecc ... change to 7.0
%P.acuScale = 0.0;   P.sampling_mid = 8.5; %9.0;   % 5 deg ecc
%*** Day Seven
%P.acuScale = -0.2;  P.sampling_mid = 9.5;   % 4 deg ecc
%P.acuScale = -0.6;  P.sampling_mid = 11.0;  % 2 deg ecc
%*** Day Eight
%P.acuScale = 1.0;  P.sampling_mid = 5.5;   % 10 deg ecc
%P.acuScale = 1.4;  P.sampling_mid = 4.5;   % 12 deg ecc
%*** Day Nine
%P.acuScale = 1.4;  P.sampling_mid = 5.5; %5.0; %4.5;   % 12 deg ecc
%P.acuScale = 1.0;  P.sampling_mid = 6.0; %5.5;   % 10 deg ecc
%*** Day Ten
%P.acuScale = 1.0;  P.sampling_mid = 6.0; %5.5;   % 10 deg ecc
%P.acuScale = 1.4;  P.sampling_mid = 5.5; %5.0; %4.5;   % 12 deg ecc
%*** Day Eleven ... on IPAD
% P.acuScale = 0.2;   P.sampling_mid = 7.0;   % 6 deg ecc
% P.acuScale = 0.6;   P.sampling_mid = 6.0;   % 8 deg ecc
%** Day Twelve
P.acuScale = 1.0;  P.sampling_mid = 6.0; %5.5;   % 10 deg ecc
%P.acuScale = 1.4;  P.sampling_mid = 5.0; %5.0; %4.5;   % 12 deg ecc
...
%****** fixation properties
P.fixPointRadius = 0.45; % 0.75;  %for small face
...
P.fixWinRadius = 1.8; %1.5; %  by JM 3/10/16
S.fixWinRadius = 'Fixation window radius (deg):';
P.stimWinMinRad = 1.9; %1.75;  % by JM
