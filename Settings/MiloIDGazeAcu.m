...
% PROTOCOL PREFIX
S.protocol = 'IDGazeAcu';
% DEFAULT SUBJECT
S.subject = 'Milo';

% DEFINE THE TASK FUNCTIONS 
% "initialization" m-file
S.initFunc = 'IDGazeAcuInit';
% "next trial" m-file
S.nextFunc = 'IDGazeAcuNext';
% "run trial" m-file
S.runFunc = 'IDGazeAcuRun';
% "finish trial" m-file
S.endFunc = 'IDGazeAcuEnd';
% "plot trial" m-file
S.plotFunc = 'IDGazeAcuPlot';

% Define Banner text to identify the experimental protocol
% recommend maximum of ~28 characters
S.protocolTitle = 'Gaze Cue and Identity Task';
...
for zk = 1:size(S.sf_sampling,2)
    ...
    %for k = 2:2:P.apertures   % only diagonal locations for now
        ...
        mjuice = 5 + floor(S.sf_sampling(zk)/2);
