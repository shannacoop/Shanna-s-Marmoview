...
S.initFunc = 'FixFlashInit';
% "next trial" m-file
S.nextFunc = 'FixFlashNext';
% "run trial" m-file
S.runFunc = 'FixFlashRun';
% "finish trial" m-file
S.endFunc = 'FixFlashEnd';
% "plot trial" m-file
S.plotFunc = 'FixFlashPlot';
...
% Stimulus settings
P.fixPointRadius = .3; % in deg, but recommended > than 4 pixels
...
P.vpxOutChannel = 5; % NOTE THAT THIS IS NOT THE INTAN INPUT, e.g. 5 --> 2
