...
S.initFunc = 'GazeAcuInit';
% "next trial" m-file
S.nextFunc = 'GazeAcuNext';
% "run trial" m-file
S.runFunc = 'GazeAcuRun';
% "finish trial" m-file
S.endFunc = 'GazeAcuEnd';
% "plot trial" m-file
S.plotFunc = 'GazeAcuPlot';

% Define Banner text to identify the experimental protocol
% recommend maximum of ~28 characters
S.protocolTitle = 'Gaze Cue and Acuity Task';
