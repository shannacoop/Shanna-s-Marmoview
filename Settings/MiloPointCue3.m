...
S.initFunc = 'PointCueInit3';
% "next trial" m-file
S.nextFunc = 'PointCueNext3';
% "run trial" m-file
S.runFunc = 'PointCueRun3';
% "finish trial" m-file
S.endFunc = 'PointCueEnd3';
% "plot trial" m-file
S.plotFunc = 'PointCuePlot3';
...
% S.sf_sampling =     [  3.5   2.5   1.2   0.9   0.7  0.1];  %1/3
