...
S.initFunc = 'PointCueInit4';
% "next trial" m-file
S.nextFunc = 'PointCueNext4';
% "run trial" m-file
S.runFunc = 'PointCueRun4';
% "finish trial" m-file
S.endFunc = 'PointCueEnd4';
% "plot trial" m-file
S.plotFunc = 'PointCuePlot4';
...
%P.dotColor = 107;  P.dotFade = -0.7; P.apertureWidth = 2;  P.apertureRadius =  1.4;   %  end of 1/18 
%P.dotColor = 97;   P.dotFade = -1.0; P.apertureWidth = 2;  P.apertureRadius =  1.4;   %   
%P.dotColor = 87;   P.dotFade = -1.2; P.apertureWidth = 1;  P.apertureRadius =  1.4;   % end of 1/23 
%P.dotColor = 77;   P.dotFade = -1.5; P.apertureWidth = 1;  P.apertureRadius =  1.4;   %   
%P.dotColor = 67;   P.dotFade = -1.8; P.apertureWidth = 0;  P.apertureRadius =  1.5;   %   end of 1/25
%P.dotColor = 45;   P.dotFade = -2.0; P.apertureWidth = 0;  P.apertureRadius =  1.6;   %   
%P.dotColor = 30;   P.dotFade = -2.5; P.apertureWidth = 0;  P.apertureRadius =  1.8;   %   
P.dotColor = 0;    P.dotFade = -3.0; P.apertureWidth = 0;  P.apertureRadius =  2.0;   %   end of 1/26
